...
(function() {
  ...
  BunyanDebugStream = (function(superClass) {
    ...
    function BunyanDebugStream(options1) {
      var c, key, level, levelName, levelValue, ref1, ref10, ref11, ref12, ref13, ref14, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, self, value;
    ...
    BunyanDebugStream.prototype._entryToString = function(entry) {
      var colorsToApply, cols, consumed, date, field, i, key, len, levelPrefix, line, linePrefix, message, preColorsToApply, prefixer, prefixes, processStr, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, src, start, stringifier, value, valueString, values;
      if (typeof entry === 'string') {
        entry = JSON.parse(entry);
      }
      colorsToApply = this._colors[(ref1 = entry.level) != null ? ref1 : bunyan.INFO];
      preColorsToApply = this._colors[bunyan.TRACE];
      ...
      line = "" + (applyColors(linePrefix, preColorsToApply)) + (applyColors(message, colorsToApply));
